...
urlpatterns = [
    ...
    path('detail2/<int:pk>/',views.ProductDetailView.as_view(), name='detail2'), #product:detail2
    ...
    path('edit2/<int:pk>/',views.ProductUpdateView.as_view(), name='edit2'), #product:edit2
    path('remove/<int:pk>/',views.ProductDeleteView.as_view(), name='remove'), #product:remove
    path('remove2/<int:pk>/',views.Product, name='remove2'), #product:remove
]